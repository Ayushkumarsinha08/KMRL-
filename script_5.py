...
class BaseChannelWorker:
    ...
    def move_to_staging(self, source_path: str, metadata: Dict[str, Any]) -> str:
        """Move file to staging area with metadata"""
...
# Save channel workers
with open('document_ingestion_system/channels/channel_workers.py', 'w') as f:
    f.write(channel_workers_code)

print("✅ Channel workers created: document_ingestion_system/channels/channel_workers.py")