...
def get_database_session():
    database_url = os.getenv('DATABASE_URL', 'sqlite:///kmrl_documents.db')
...
# Save to file
with open('document_ingestion_system/database/models.py', 'w') as f:
    f.write(database_models_code)

print("✅ Database models created: document_ingestion_system/database/models.py")