...
# Save main orchestrator
with open('document_ingestion_system/main.py', 'w') as f:
    f.write(main_orchestrator_code)

print("✅ Main orchestrator created: document_ingestion_system/main.py")