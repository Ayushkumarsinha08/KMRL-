# 7. Configuration and Main Orchestrator
config_code = '''
...
# Save configuration
with open('document_ingestion_system/config/settings.py', 'w') as f:
    f.write(config_code)

print("✅ Configuration file created: document_ingestion_system/config/settings.py")