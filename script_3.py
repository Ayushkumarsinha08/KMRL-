...
# Save extractors
with open('document_ingestion_system/extractors/extractors.py', 'w') as f:
    f.write(extractors_code)

print("✅ File extractors created: document_ingestion_system/extractors/extractors.py")