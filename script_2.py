...
# Save file detector
with open('document_ingestion_system/utils/file_detector.py', 'w') as f:
    f.write(file_detector_code)

print("✅ File type detector created: document_ingestion_system/utils/file_detector.py")