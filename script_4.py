...
class DepartmentClassifier:
    ...
    def classify(self, text: str, filename: str = "", metadata: Dict = None) -> Dict[str, any]:
        """
...
# Save classifier
with open('document_ingestion_system/classifiers/department_classifier.py', 'w') as f:
    f.write(classifier_code)

print("✅ Department classifier created: document_ingestion_system/classifiers/department_classifier.py")